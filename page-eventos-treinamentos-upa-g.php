<?php
/*
Template Name: EVENTOS E TREINAMENTOS UPA GOIANESIA
*/
?>
         ...
         <div class="row">
            ...
            <!-- Main Blog Content -->
               ...
               <?php
					...
					$wp_query->query('post_type=post&cat=103&orderby=date&order=DESC&posts_per_page=4&paged=' . $paged);
            ...
            <div class="col-md-3">
	            ...
	            <?php
					...
					if(is_active_sidebar('eventos-treinamentos-upa-g')){

						dynamic_sidebar('eventos-treinamentos-upa-g');
