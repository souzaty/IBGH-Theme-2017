<?php
   /* Template Name: CORPO CLINICO RESULTADO HMA */
?>
...
<div class="container">
   <div class="row">
      <div class="col-md-12">
         <form class="busca-transparencia" role="search" id="busca-transparencia" method="get" action="<?php echo get_site_url(); ?>/unidades/hospital-municipal-de-araguaina/corpo-clinico-resultado-da-busca/">
            <div class="input-group">
               <div class="">
                  <?php
                     $select  = wp_dropdown_categories('show_option_none=Filtrar por especialidade&hide_empty=0&echo=0&id=unidadeSelect&class=form-control input-label&post_type=corpo-clinico-hma&value_field=slug&taxonomy=Especialidades HMA&orderby=taxonomy_slug=Especialidades HMA&order=ASC');
                     $replace = "<select$1>";
         ...
         <?php
            ...
            $curso_tipo = array(
            		'post_type' => 'corpo_clinico_hma',
            		'posts_per_page' => -1,
            		'tax_query' => array(
            				array(
            						'taxonomy' => 'Especialidades HMA',
            						'field'    => 'slug',
            						'terms'    => $especialidade,
            				),
            		),
         ...
         <div class="col-md-3 resultato-corpo-clinico">
            ...
            <?php $categorias = $categories = get_the_terms( $post_id, 'Especialidades HMA' ); ?>
            <p class="especialidade center"><?php foreach( $categorias as $categoria ) { echo $categoria->name; }?></p>
            <p class="crm green center">CRM <?php $corpo_crm_hma = get_post_meta($post->ID, 'corpo_crm_hma', true); echo $corpo_crm_hma; ?></p>
         </div>
