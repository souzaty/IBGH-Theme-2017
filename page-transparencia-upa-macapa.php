<?php
   /* Template Name: TRANSPARENCIA UPA MACAPA */
?>
<?php get_header(); ?>
      ...
      <div class="container">
         <div class="row">
            <div class="col-md-9 col-sm-12">
               ...
               <?php
                  $wp_query = new WP_Query();
                  $wp_query->query('post_type=transparencia&taxonomy=Ano&2017&tipo-documento=upa-zona-sul-de-macapa');
                  ?>
               <?php
                                       ...
                                       <div class="col-xs-12 col-sm-8 col-lg-8 no-padding right">
                                          <div id="content-transparencia" class="tab-content">
                                             <div class="tab-pane  active" id="relacao-gestores">
                                                <?php
                                                   $wp_query = new WP_Query();
                                                   $wp_query->query('post_type=transparencia&tipo-documento=upa-macapa-balancetes&posts_per_page=100');
                                                   $count = 0;
                                                   ?>
                                             ...
                                             <div class="tab-pane" id="balancos">
                                                <?php
                                                   $wp_query = new WP_Query();
                                                   $wp_query->query('post_type=transparencia&tipo-documento=upa-macapa-balancos&posts_per_page=100');
                                                   $count = 0;
                                                   ?>
                                                <?php include 'includes/transparencia-resultado-lista.php'; ?>
                                             </div>
                                       ...
                                       <div class="col-xs-12 col-sm-8 col-lg-8 no-padding right">
                                          <div id="content-transparencia" class="tab-content">
                                             <div class="tab-pane  active" id="relacao-gestores">
                                                <?php
                                                   $wp_query = new WP_Query();
                                                   $wp_query->query('post_type=transparencia&tipo-documento=upa-macapa-relacao-de-gestores&posts_per_page=100');
                                                   $count = 0;
                                                   ?>
                                                <?php include 'includes/transparencia-resultado-lista.php'; ?>
                                             </div>
                                             <div class="tab-pane" id="processos-seletivos">
                                                <?php
                                                   $wp_query = new WP_Query();
                                                   $wp_query->query('post_type=transparencia&tipo-documento=upa-macapa-processos-seletivos&posts_per_page=100');
                                                   $count = 0;
                                                   ?>
                                                <?php include 'includes/transparencia-resultado-lista.php'; ?>
                                             </div>
                                             <div class="tab-pane" id="ses">
                                                <?php
                                                   $wp_query = new WP_Query();
                                                   $wp_query->query('post_type=transparencia&tipo-documento=upa-macapa-transferencia-ses&posts_per_page=100');
                                                   $count = 0;
                                                   ?>
                                                <?php include 'includes/transparencia-resultado-lista.php'; ?>
                                             </div>
                                             <div class="tab-pane" id="organograma">
                                                <?php
                                                   $wp_query = new WP_Query();
                                                   $wp_query->query('post_type=transparencia&tipo-documento=upa-macapa-organograma&posts_per_page=100');
                                                   $count = 0;
                                                   ?>
                                                <?php include 'includes/transparencia-resultado-lista.php'; ?>
                                             </div>
                                          ...
                                          <div class="col-xs-12 col-sm-8 col-lg-8 no-padding right">
                                             <div id="content-transparencia" class="tab-content">
                                                ...
                                                <div class="tab-pane" id="alvaras">
                                                   <?php
                                                      $wp_query = new WP_Query();
                                                      $wp_query->query('post_type=transparencia&tipo-documento=upa-macapa-alvaras&posts_per_page=100');
                                                      $count = 0;
                                                      ?>
                                                   <?php include 'includes/transparencia-resultado-lista.php'; ?>
                                                </div>
                                                <div class="tab-pane" id="atas">
                                                   <?php
                                                      $wp_query = new WP_Query();
                                                      $wp_query->query('post_type=transparencia&tipo-documento=upa-macapa-atas&posts_per_page=100');
                                                      $count = 0;
                                                      ?>
                                                   <?php include 'includes/transparencia-resultado-lista.php'; ?>
                                                </div>
                                                <div class="tab-pane" id="comissoes">
                                                   <?php
                                                      $wp_query = new WP_Query();
                                                      $wp_query->query('post_type=transparencia&tipo-documento=upa-macapa-comissoes&posts_per_page=100');
                                                      $count = 0;
                                                      ?>
                                                   <?php
                                                ...
                                                <div class="tab-pane" id="pareceres">
                                                   <?php
                                                      $wp_query = new WP_Query();
                                                      $wp_query->query('post_type=transparencia&tipo-documento=upa-macapa-pareceres&posts_per_page=100');
                                                      $count = 0;
                                                      ?>
                                                   <?php
                                                      include 'includes/transparencia-resultado-lista.php';
                                                ...
                                                <div class="tab-pane" id="processo-de-aquisicao">
                                                   <?php
                                                      $wp_query = new WP_Query();
                                                      $wp_query->query('post_type=transparencia&tipo-documento=upa-macapa-processos-de-aquisicao&posts_per_page=100');
                                                      $count = 0;
                                                      ?>
                                                   <?php include 'includes/transparencia-resultado-lista.php'; ?>
                                                </div>
                                                <div class="tab-pane" id="relatorio-de-atividades">
                                                   <?php
                                                      $wp_query = new WP_Query();
                                                      $wp_query->query('post_type=transparencia&tipo-documento=upa-macapa-relatorio-de-atividades&posts_per_page=100');
                                                      $count = 0;
                                                      ?>
                                                   <?php
                                                      include 'includes/transparencia-resultado-lista.php';
                                          ...
                                          <div class="col-xs-12 col-sm-8 col-lg-8 no-padding right">
                                             <div id="content-transparencia" class="tab-content">
                                                <div class="tab-pane  active" id="upacdg">
                                                   <?php
                                                      $wp_query = new WP_Query();
                                                      $wp_query->query('post_type=transparencia&tipo-documento=upa-amacapa-contratos-de-gestao&posts_per_page=100');
                                                      $count = 0;
                                                      ?>
                                                   <?php
                                                      include 'includes/transparencia-resultado-lista.php';
                                                ...
                                                <div class="tab-pane" id="resumo-de-contratos">
                                                   <?php
                                                      $wp_query = new WP_Query();
                                                      $wp_query->query('post_type=transparencia&tipo-documento=upa-macapa-resumo-de-contratos&posts_per_page=100');
                                                      $count = 0;
                                                      ?>
                                                   <?php
                                                      include 'includes/transparencia-resultado-lista.php';
                                                ...
                                                <div class="tab-pane" id="regulamentos">
                                                   <?php
                                                      $wp_query = new WP_Query();
                                                      $wp_query->query('post_type=transparencia&tipo-documento=upa-macapa-regulamentos-de-compras&posts_per_page=100');
                                                      $count = 0;
                                                      ?>
                                                   <?php
                                                      include 'includes/transparencia-resultado-lista.php';
                                          ...
                                          <div class="col-xs-12 col-sm-8 col-lg-8 no-padding right">
                                             <div id="content-transparencia" class="tab-content">
                                                <div class="tab-pane  active" id="contratos-de-gestao">
                                                   <?php
                                                      $wp_query = new WP_Query();
                                                      $wp_query->query('post_type=transparencia&tipo-documento=upa-macapa-relatorio-de-resultados&posts_per_page=100');
                                                      $count = 0;
                                                      ?>
                                                   <?php
                                                      include 'includes/transparencia-resultado-lista.php';
