<?php
    /* Template Name: TRANSPARENCIA HEELJ */
?>
<?php
get_header();
?>
...
?>
                        ...
                        <!-- /btn-group -->
                        <input type="text" class="form-control input-label" aria-label="..." type="search" name="pesquisa_transparencia" id="pesquisa_transparencia" placeholder="Qual documento você está procurando?">
...
?>
               <?php
$wp_query = new WP_Query();
$wp_query->query('post_type=transparencia&taxonomy=Ano&2017&tipo-documento=heelj');
?>
               <?php
                                    ...
                                    <div class="bloco-body">
                                       <div class="col-xs-12 col-sm-4 col-lg-4 no-padding left">
                                          <ul class="nav nav-tabs tabs-left ">
                                             ...
                                             <li class=""><a href="#folhas" data-toggle="tab"
                                                aria-expanded="false">Folhas de Pagamento</a></li>
                                          </ul>
                                       </div>
...
?>
                                             ...
                                             <div class="tab-pane" id="folhas">
                                                <?php
$wp_query = new WP_Query();
$wp_query->query('post_type=transparencia&tipo-documento=heelj-folhas-de-pagamento&posts_per_page=100');
$count = 0;
?>
                                               <?php include 'includes/transparencia-resultado-lista.php'; ?>
                                             </div>
...
?>
                        ...
                        <?php
$wp_query = new WP_Query();
$wp_query->query('post_type=transparencia&ano=' . $ano . '&tipo-documento=heelj-relatorio-atividades&posts_per_page=100');
$count = 0;
?>
                        <?php
include 'includes/transparencia-resultado-lista.php';
