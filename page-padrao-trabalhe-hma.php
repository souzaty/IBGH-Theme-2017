<?php
	/* Template Name: TRABALHE CONOSCO HMA */
?>
	...
	<div class="container">
		<div class="row">
			<div class="col-md-12">
				...
				<h2 style="color: #c6c6c6;margin-top: -40px;text-align: center;">Sem editais vigentes</h2>
			</div>
<!-- ############################## Tab ############################## -->
		</div>
		<div class="row">
			...
			<div class="col-sm-12">
				...
				<div class="container-tab">
					...
					<button style="display: inline-block; float: right; " type="button" class="btn btn-default btn-green-fill" aria-label="Right Align" ><b>Inscrições abertas</b></button>
					</a>
					...
					<?php }?>
					<hr style="margin:0">
					<div class="col-md-3" style="padding: 0;margin-top: 4px;height: 100%;padding: 10px 5px 50px 5px;background: #fff;height: 500px;">
