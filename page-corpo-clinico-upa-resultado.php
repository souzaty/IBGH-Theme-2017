<?php
/* Template Name: CORPO CLINICO RESULTADO UPA */
?>
		...
		<div class="col-md-12">
			<form class="busca-transparencia" role="search" id="busca-transparencia" method="get" action="<?php echo get_site_url(); ?>/unidades/upa-araguaina/corpo-clinico-resultado-da-busca/">
				<div class="input-group">
					<div class="">
						<?php
							$select  = wp_dropdown_categories('show_option_none=Filtrar por especialidade&hide_empty=0&echo=0&id=unidadeSelect&class=form-control input-label&post_type=corpo-clinico-upaj&value_field=slug&taxonomy=Especialidades UPA&orderby=taxonomy_slug=Especialidades UPA&order=ASC');
							$replace = "<select$1>";
			...
			<?php
				...
				$curso_tipo = array(
						'post_type' => 'corpo_clinico_upa',
						'posts_per_page' => -1,
						'tax_query' => array(
								array(
										'taxonomy' => 'Especialidades UPA',
										'field'    => 'slug',
										'terms'    => $especialidade,
								),
						),
