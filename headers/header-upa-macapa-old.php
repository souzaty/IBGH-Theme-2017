	...
	<div class="container">
		<div class="container-fluid">
			...
			<?php wp_nav_menu( array(
				...
				'theme_location' => 'menu_topo_upa_macapa',
...
<div class="container-fluid clearHeader">
	<div class="row">
				...
				<div class="row gutter-0">
					<div class="col-md-5">
						<div class="navbar-header" style="width:100%">
							...
							<a class="" href="http://ibgh.org.br/unidades/upa-macapa"><span class="logo-upa-header logo-macapa"></span></a>
							</span>
						</div>
					</div>
					<div class="col-md-7">
						<?php wp_nav_menu ( array (
							...
							'menu' => 'menu_principal_upa_macapa',

							'theme_location' => 'menu_principal_upa_macapa',
		...
		<!-- Modal 7 -->
		<div class="modal fade bg-modal-menu" id="modal7" tabindex="-1" role="dialog" aria-labelledby="modal7" aria-hidden="true">
							...
							<div class="container">
								...
								<div class="col-md-4 separator">
									<?php wp_nav_menu ( array (
										...
										'menu' => 'menu_principal_modal_ohospital_upa_macapa_c1',

										'theme_location' => 'menu_principal_modal_ohospital_upa_macapa_c1',
								...
								<div class="col-md-4 separator-duplo">
									<?php
										...
										'menu' => 'menu_principal_modal_ohospital_upa_macapa_c2',

										'theme_location' => 'menu_principal_modal_ohospital_upa_macapa_c2',
								...
								<div class="col-md-4 separator last">
									<?php wp_nav_menu ( array (
										...
										'menu' => 'menu_principal_modal_ohospital_upa_macapa_c3',

										'theme_location' => 'menu_principal_modal_ohospital_upa_macapa_c3',
