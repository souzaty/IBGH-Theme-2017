      ...
      <div class="row">
         <div class="col-md-9">
            ...
            <?php global $post;
               ...
               $wp_query->query('post_type=post&cat=257&orderby=date&order=DESC&posts_per_page=4&paged=' . $paged);
                ?>
         ...
         <!-- End col-md-9 -->
         <div class="col-md-3">
            <?php if(is_active_sidebar('eventos-treinamentos-macapa')){
               dynamic_sidebar('eventos-treinamentos-macapa');
               }
               ?>
         </div>
      </div>
