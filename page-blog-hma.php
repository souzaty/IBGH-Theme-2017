<?php
	/* Template Name: BLOG HMA */
?>
<div id="pagina-interna-hma">
	<?php get_header(); ?>
</div>
		...
		<div class="row">
			<div class="col-md-9">
				...
				<?php
					...
					$wp_query->query('post_type=post&cat=37&orderby=date&order=DESC&posts_per_page=4&paged=' . $paged);
					 ?>
				<?php if ($wp_query->have_posts()) : while ($wp_query->have_posts()) : $wp_query->the_post();?>
				<div class="postResume">
					<article>
						<div class="col-md-5 gutter-30 no-gutter-30-right">
							<?php the_post_thumbnail('noticias-home-hma'); ?>
						</div>
			...
			<div class="col-md-3">
				<?php
					if(is_active_sidebar('eventos-treinamentos-hma')){
						dynamic_sidebar('eventos-treinamentos-hma');
					}
					?>
			</div>
		</div>
