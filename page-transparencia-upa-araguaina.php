<?php
   /* Template Name: TRANSPARENCIA UPA ARAGUAINA */
?>
<?php get_header(); ?>
   ...
   <section id="numeros-full" class="ghost">
      <div class="container">
         <div class="row gutter-0">
            <?php include 'includes/upa-a-section_numbers_full.php'; ?>
         </div>
      </div>
   </section>
      ...
      <div class="container">
         <div class="row">
            <div class="col-md-9 col-sm-12">
               ...
               <?php
                  $wp_query = new WP_Query();
                  $wp_query->query('post_type=transparencia&taxonomy=Ano&2017&tipo-documento=upa-anatolio-dias-carneiro-de-araguaina');
                  ?>
               <?php
                                       ...
                                       <div class="col-xs-12 col-sm-8 col-lg-8 no-padding right">
                                          <div id="content-transparencia" class="tab-content">
                                             <div class="tab-pane  active" id="relacao-gestores">
                                                <?php
                                                   $wp_query = new WP_Query();
                                                   $wp_query->query('post_type=transparencia&tipo-documento=upa-araguaina-balancetes&posts_per_page=100');
                                                   $count = 0;
                                                   ?>
                                             ...
                                             <div class="tab-pane" id="balancos">
                                                <?php
                                                   $wp_query = new WP_Query();
                                                   $wp_query->query('post_type=transparencia&tipo-documento=upa-araguaina-balancos&posts_per_page=100');
                                                   $count = 0;
                                                   ?>
                                                <?php include 'includes/transparencia-resultado-lista.php'; ?>
                                             </div>
                                       ...
                                       <div class="col-xs-12 col-sm-8 col-lg-8 no-padding right">
                                          <div id="content-transparencia" class="tab-content">
                                             <div class="tab-pane  active" id="relacao-gestores">
                                                <?php
                                                   $wp_query = new WP_Query();
                                                   $wp_query->query('post_type=transparencia&tipo-documento=upa-araguaina-relacao-de-gestores&posts_per_page=100');
                                                   $count = 0;
                                                   ?>
                                                <?php include 'includes/transparencia-resultado-lista.php'; ?>
                                             </div>
                                             <div class="tab-pane" id="processos-seletivos">
                                                <?php
                                                   $wp_query = new WP_Query();
                                                   $wp_query->query('post_type=transparencia&tipo-documento=upa-araguaina-processos-seletivos&posts_per_page=100');
                                                   $count = 0;
                                                   ?>
                                                <?php include 'includes/transparencia-resultado-lista.php'; ?>
                                             </div>
                                             <div class="tab-pane" id="ses">
                                                <?php
                                                   $wp_query = new WP_Query();
                                                   $wp_query->query('post_type=transparencia&tipo-documento=upa-araguaina-transferencia-ses&posts_per_page=100');
                                                   $count = 0;
                                                   ?>
                                                <?php include 'includes/transparencia-resultado-lista.php'; ?>
                                             </div>
                                             <div class="tab-pane" id="organograma">
                                                <?php
                                                   $wp_query = new WP_Query();
                                                   $wp_query->query('post_type=transparencia&tipo-documento=upa-araguaina-organograma&posts_per_page=100');
                                                   $count = 0;
                                                   ?>
                                                <?php include 'includes/transparencia-resultado-lista.php'; ?>
                                             </div>
                                          ...
                                          <div class="col-xs-12 col-sm-8 col-lg-8 no-padding right">
                                             <div id="content-transparencia" class="tab-content">
                                                ...
                                                <div class="tab-pane" id="alvaras">
                                                   <?php
                                                      $wp_query = new WP_Query();
                                                      $wp_query->query('post_type=transparencia&tipo-documento=upa-araguaina-alvaras&posts_per_page=100');
                                                      $count = 0;
                                                      ?>
                                                   <?php include 'includes/transparencia-resultado-lista.php'; ?>
                                                </div>
                                                <div class="tab-pane" id="atas">
                                                   <?php
                                                      $wp_query = new WP_Query();
                                                      $wp_query->query('post_type=transparencia&tipo-documento=upa-araguaina-atas&posts_per_page=100');
                                                      $count = 0;
                                                      ?>
                                                   <?php include 'includes/transparencia-resultado-lista.php'; ?>
                                                </div>
                                                <div class="tab-pane" id="comissoes">
                                                   <?php
                                                      $wp_query = new WP_Query();
                                                      $wp_query->query('post_type=transparencia&tipo-documento=upa-araguaina-comissoes&posts_per_page=100');
                                                      $count = 0;
                                                      ?>
                                                   <?php
                                                ...
                                                <div class="tab-pane" id="pareceres">
                                                   <?php
                                                      $wp_query = new WP_Query();
                                                      $wp_query->query('post_type=transparencia&tipo-documento=upa-araguaina-pareceres&posts_per_page=100');
                                                      $count = 0;
                                                      ?>
                                                   <?php
                                                      include 'includes/transparencia-resultado-lista.php';
                                                ...
                                                <div class="tab-pane" id="processo-de-aquisicao">
                                                   <?php
                                                      $wp_query = new WP_Query();
                                                      $wp_query->query('post_type=transparencia&tipo-documento=upa-araguaina-processos-de-aquisicao&posts_per_page=100');
                                                      $count = 0;
                                                      ?>
                                                   <?php include 'includes/transparencia-resultado-lista.php'; ?>
                                                </div>
                                                <div class="tab-pane" id="relatorio-de-atividades">
                                                   <?php
                                                      $wp_query = new WP_Query();
                                                      $wp_query->query('post_type=transparencia&tipo-documento=upa-araguaina-relatorio-de-atividades&posts_per_page=100');
                                                      $count = 0;
                                                      ?>
                                                   <?php
                                                      include 'includes/transparencia-resultado-lista.php';
                                 ...
                                 <div class="col-md-12">
                                    <div class="bloco">
                                       ...
                                       <div class="bloco-body">
                                          <div class="col-xs-12 col-sm-4 col-lg-4 no-padding left">
                                             <ul class="nav nav-tabs tabs-left ">
                                                <li class="active"><a href="#upacdg" data-toggle="tab"
                                          ...
                                          <div class="col-xs-12 col-sm-8 col-lg-8 no-padding right">
                                             <div id="content-transparencia" class="tab-content">
                                                <div class="tab-pane  active" id="upacdg">
                                                   <?php
                                                      $wp_query = new WP_Query();
                                                      $wp_query->query('post_type=transparencia&tipo-documento=upa-araguaina-contratos-de-gestao&posts_per_page=100');
                                                      $count = 0;
                                                      ?>
                                                   <?php
                                                      include 'includes/transparencia-resultado-lista.php';
                                                ...
                                                <div class="tab-pane" id="resumo-de-contratos">
                                                   <?php
                                                      $wp_query = new WP_Query();
                                                      $wp_query->query('post_type=transparencia&tipo-documento=upa-araguaina-resumo-de-contratos&posts_per_page=100');
                                                      $count = 0;
                                                      ?>
                                                   <?php
                                                      include 'includes/transparencia-resultado-lista.php';
                                                ...
                                                <div class="tab-pane" id="regulamentos">
                                                   <?php
                                                      $wp_query = new WP_Query();
                                                      $wp_query->query('post_type=transparencia&tipo-documento=upa-araguaina-regulamentos-de-compras&posts_per_page=100');
                                                      $count = 0;
                                                      ?>
                                                   <?php
                                                      include 'includes/transparencia-resultado-lista.php';
                                          ...
                                          <div class="col-xs-12 col-sm-8 col-lg-8 no-padding right">
                                             <div id="content-transparencia" class="tab-content">
                                                <div class="tab-pane  active" id="contratos-de-gestao">
                                                   <?php
                                                      $wp_query = new WP_Query();
                                                      $wp_query->query('post_type=transparencia&tipo-documento=upa-araguaina-relatorio-de-resultados&posts_per_page=100');
                                                      $count = 0;
                                                      ?>
                                                   <?php
                                                      include 'includes/transparencia-resultado-lista.php';
